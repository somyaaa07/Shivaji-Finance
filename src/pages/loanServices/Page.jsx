...
const LOAN_DATA = {
  "Personal Loan": {
    ...
    rate: "10.5%", maxAmount: "₹25 Lakhs", tenure: "Up to 5 Years", disbursal: "24 Hours",
    ...
    docs: [...DOCS_BASE], conditions: CONDITIONS, steps: STEPS,
    faqs: [
  ...
  "Home Loan": {
    ...
    rate: "8.5%", maxAmount: "₹5 Crore", tenure: "Up to 30 Years", disbursal: "48 Hours",
    ...
    docs: [...DOCS_BASE, { category: "Property Docs", items: ["Sale deed / Agreement", "Property tax receipts", "NOC from society/builder"] }],
  ...
  "Business Loan": {
    ...
    rate: "11%", maxAmount: "₹2 Crore", tenure: "Up to 7 Years", disbursal: "48 Hours",
    ...
    docs: [...DOCS_BASE, { category: "Business Docs", items: ["GST Registration", "Business ITR (2 years)", "P&L Statement", "Business license/registration"] }],
    conditions: [...CONDITIONS.slice(0, 2), { icon: BarChart2, title: "Business Vintage", desc: "Minimum 2 years of business operation required." }, ...CONDITIONS.slice(3)],
    steps: STEPS,
    faqs: [
  ...
  "Education Loan": {
    ...
    rate: "9%", maxAmount: "₹50 Lakhs", tenure: "Up to 15 Years", disbursal: "72 Hours",
  ...
  "Auto Loan": {
    ...
    rate: "9.5%", maxAmount: "₹1.5 Crore", tenure: "Up to 8 Years", disbursal: "24 Hours",
  ...
  "Gold Loan": {
    ...
    rate: "7.5%", maxAmount: "₹1 Crore", tenure: "Up to 3 Years", disbursal: "Same Day",
  ...
  "Loan Against Property": {
    ...
    rate: "9%", maxAmount: "₹10 Crore", tenure: "Up to 20 Years", disbursal: "5–7 Days",
    features: ["Up to 70% LTV", "Residential & Commercial", "Balance Transfer", "Top-Up Facility"],
    image: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=600&q=80",
    docs: [...DOCS_BASE, { category: "Property Documents", items: ["Title deed / Sale deed", "Property tax receipts (last 3 years)", "Encumbrance certificate", "Approved building plan", "NOC from society/authority"] }],
    conditions: CONDITIONS, steps: STEPS,
    faqs: [
  ...
  "Medical Loan": {
    ...
    rate: "11%", maxAmount: "₹20 Lakhs", tenure: "Up to 5 Years", disbursal: "4 Hours",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pb-16 flex flex-col lg:flex-row gap-6 lg:gap-8 items-start">
        ...
        <aside className="hidden lg:flex lg:w-64 flex-shrink-0 flex-col gap-4 sticky" style={{ top: "1.5rem" }}>
          ...
          <div className="rounded-2xl p-5 text-center shadow-md" style={{ backgroundColor: "#2b394b" }}>
            ...
            <p className="text-white font-bold mb-1 text-sm">Need Help?</p>
            <p className="text-xs mb-2" style={{ color: "#a8bbc8" }}>Mon – Sat, 9AM – 6PM</p>
            <p className="text-base font-bold" style={{ color: "#cacdd2" }}>1800-123-4567</p>
            <p className="text-xs mt-0.5" style={{ color: "#a8bbc8" }}>Toll Free</p>
          </div>
        </aside>
